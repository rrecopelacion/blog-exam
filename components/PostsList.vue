<template>
  <section class="section post-section" id="js-news-section">
      <div class="l-container">
        ...
        <div class="post-content">
          <ul class="post-list-group flex flex-start">
            <li
...
export default {
  ...
  data() {
    return {
      limit: 6,
      index: 0,
      placeholder: require('../assets/images/placeholder280x200.png'),
    }
  },
  methods: {
...
<style scoped lang="scss" src="./PostsList.scss">
